...
For those who want to understand how the agent system works, there is a cookbook in this repository.
...
A designed organisation of fifteen roles. All fifteen are defined and registered.
...
The full role definitions, authority maps, and agent implementation notes are in the org structure document (`vm_project_org_structure_v2.pdf`).
...
| Agent organisation | All 15 roles defined and registered |
